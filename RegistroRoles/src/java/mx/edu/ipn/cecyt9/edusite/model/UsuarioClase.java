...
import mx.edu.ipn.cecyt9.edusite.model.RolClase;
...
public class UsuarioClase implements Serializable {
    ...
    @ManyToOne
    private RolClase idrol;

    public UsuarioClase() {
    }

    public UsuarioClase(Integer idusuario) {
    ...
    public RolClase getIdrol() {
        return idrol;
    }

    public void setIdrol(RolClase idrol) {
        this.idrol = idrol;
    }
    ...
    public String toString() {
        return "mx.edu.ipn.cecyt9.edusite.controller.Usuario[ idusuario=" + idusuario + " ]";
    }
